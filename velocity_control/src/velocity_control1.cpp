...
/*
void VelocityConstantCallback(const std_msgs::Float64::ConstPtr& msg)
{        
    std_msgs::Float64 msg1;
    msg1.data = velocity_constant;
    ROS_INFO("Velocity Constant %f", msg1.data);
...
class moveit_robot {
    public:
      ...
      //  ros::Subscriber gripper_feedback_sub;
       ...
       // ros::ServiceClient  set_speed_slider_client; //new
...
moveit_robot::moveit_robot(ros::NodeHandle* node_handle) : nh_(*node_handle), PLANNING_GROUP("manipulator"), visual_tools("world"), move_group(moveit::planning_interface::MoveGroupInterface(PLANNING_GROUP)) {
  ...
  //  ur_controllers::SpeedScalingStateController moveit_robot;    
   ...
   // set_speed_slider_client = nh_.serviceClient<ur_robot_driver::hardware_interface>("set_speed_slider");
...
void moveit_robot::move_robot(std::map<std::string, double> targetJoints, std::string robot_action, std::string jnt_pos_name){
  ...
  //set_speed_slider_srv_ = node_handle.advertiseService("set_speed_slider", &HardwareInterface::setSpeedSlider, 0.02);
...
/*
bool setSpeedSlider(ur_msgs::SetSpeedSliderFractionRequest& req,
...
int main(int argc, char** argv)
{
  ...
  //  ros::ServiceServer set_speed_slider_srv_ = node_handle.advertiseService("set_speed_slider", &HardwareInterface::setSpeedSlider, this);
  // ros::ServiceServer service = node_handle.advertiseService("set_speed_slider", setSpeedSlider);
 //   ros::ServiceClient client  = node_handle.serviceClient<ur_msgs::SetSpeedSliderFraction>("set_speed_slider");
   // ros::Rate loop_rate(10);
   //ur_msgs::SetSpeedSliderFraction srv;
  //  ur_msgs::SetSpeedSliderFractionRequest req;
  //  ur_msgs::SetSpeedSliderFractionResponse res;
...
int count = 0;
 ...
 // float setSpeedSlider = 0.5;
  int chatter_count = 0;
  // set_speed_slider client
  // set_speed.setSpeedSlider(0.2);  // set speed 20%
 // req.speed_slider_fraction = 0.2;
  // client.call(req, res);
/*

   if (client.call(srv))
     {
       ROS_INFO("Speed_fraction: %ld", (long int)srv.res.speed_slider_fraction);
  ...
  */
  ...
  std_msgs::String msg;
    std::stringstream ss;
    ss << "rosservice call /ur_hardware_interface/set_speed_slider " << chatter_count;
